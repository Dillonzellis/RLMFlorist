...
// minify html
// minify page templates and send to correct dir
gulp.task('mini-page', function(){
	return gulp.src([
...
// minify headers and footers and send to correct dir
gulp.task('mini-headers', function(){
	return gulp.src([
		'./header*.php',
		'./footer.php'
		])
...
// Run
// gulp compile
// Compiles the styles, scripts, runs dist, and then runs minihtml
